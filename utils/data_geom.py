...
"""splits中存储的是已经分配好的十折交叉验证对应的mask，如果输入了percentage则另外随机分配，embedding相关的参数是Geom中用到的"""


def load_data_from_file(dataset_name, splits_file_path=None, train_percentage=None, val_percentage=None, embedding_mode=None,
